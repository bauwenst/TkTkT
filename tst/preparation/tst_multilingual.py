...
def tst_japaneseSplitter():
    from tktkt.preparation.splitters import JapaneseWords

    pretokeniser = JapaneseWords()
...
def tst_thaiSplitter():
    from tktkt.preparation.splitters import ThaiWords

    pretokeniser = ThaiWords()
