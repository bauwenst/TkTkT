...
def makeTokeniser():
    ...
    objective1 = ViterbiObjective(initial_score=0, score_generator=ConstrainVocabulary(MinimiseTokenAmount(), vocab, reset_value=-INFTY), score_combiner=Plus())
    objective2 = ViterbiObjective(initial_score=0, score_generator=ConstrainVocabulary(MaximiseTokenLength(), vocab, reset_value=-INFTY), score_combiner=Max())
